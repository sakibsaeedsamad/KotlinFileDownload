...
import com.scube.kotlinfiledownload.BuildConfig.APPLICATION_ID
import com.scube.kotlinfiledownload.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    private val fileUrl = "http://10.11.201.180:8080/AgentBanking/NoticeDownloadS?id=134"
    ...
    private fun setDownloadButtonClickListener() {
        ...
        val uri = context?.let {
            FileProvider.getUriForFile(it, "${BuildConfig.LIBRARY_PACKAGE_NAME}.provider", file)
        }
